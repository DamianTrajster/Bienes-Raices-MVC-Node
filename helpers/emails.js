...
const emailOlvidePassword = async (datos) => {
    const transport = nodemailer.createTransport({
       ...
       await transport.sendMail({
         from: 'BienesRaices.com',
         to:email,
         subject: 'Restable tu password en BienesRaices',
         text: 'Restable tu password en BienesRaices',
         html: `
             <p>Hola ${nombre},has solicitado restablecer el password en bienesRaices</p>
             <p>sigue el siguiente enlace para generar password nuevo:
